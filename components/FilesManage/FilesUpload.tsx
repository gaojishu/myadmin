...
import { Button, Col, Divider, Input, Modal, Progress, Row, Select, Upload, UploadFile, type RadioChangeEvent, type UploadProps } from 'antd';
import type { FilesCategoryData, OssPostPolicy } from '@/types';
                        ...
                        <FilesVisibilityRadio
                            ...
                            fieldProps={{
                                onChange: (e: RadioChangeEvent) => {
                                    setVisibility(String(e.target.value));
                                },
                            }}
                        />
                    </Col>
